class News < ActiveRecord::Base
	...
	has_attached_file :image1, styles: { small: "64x64", med: "100x100", large: "500x500" }
	has_attached_file :image2, styles: { small: "64x64", med: "100x100", large: "500x500" }
	has_attached_file :image3, styles: { small: "64x64", med: "100x100", large: "500x500" }
	has_attached_file :image4, styles: { small: "64x64", med: "100x100", large: "500x500" }
	has_attached_file :image5, styles: { small: "64x64", med: "100x100", large: "500x500" }
